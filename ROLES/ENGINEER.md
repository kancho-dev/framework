# Role Instructions: Engineer

Use this role when you are making or reviewing code changes.
...
2. Do not leave partial work without a clear handoff.
3. Do not mix unrelated changes into one task unless the user asked for that.
